RSpec.describe Peatio::Pepscoin::Wallet do
  let(:wallet) { Peatio::Pepscoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Pepscoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Pepscoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
